...
public class ImageAdapter extends BaseAdapter 
{
	...
	public Integer[] imgs = { R.drawable.cover1, R.drawable.cover2, R.drawable.cover3,
			  R.drawable.cover4, R.drawable.cover5};
	public String[] titles = { "美图01", "美图02", "美图03", "美图04", "美图05", "美图06", "美图07"};

	public ImageAdapter(Context c) 
	{
		this.mContext = c;
		//this.imgs = album_cover;
		//this.titles = album_name;
